...
(function ($) {
  ...
  function home_projects_filters() {
    var owl = jQuery('.owl-carousel-filters').owlCarousel({
      loop: true,
      autoplay: true,
      margin: 20,
      nav: false,
  ...
  function home_projects_filterss() {
    var owl = jQuery('.owl-carousel-filtera').owlCarousel({
      loop: true,
      autoplay: true,
      margin: 20,
      nav: false,
  ...
  jQuery(document).ready(function () {
    ...
    input_number_vertical_form(),
      ...
      home_projects_filters(),
      home_projects_filterss(),
      //  Service Gallery Carousel twelve function by = owl.carousel.js ========================== //
